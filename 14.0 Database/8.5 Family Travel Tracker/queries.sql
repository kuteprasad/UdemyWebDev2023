...
DROP TABLE IF EXISTS visited_countries_2, users;
...
CREATE TABLE visited_countries_2(
id SERIAL PRIMARY KEY,
...
INSERT INTO visited_countries_2 (country_code, user_id)
VALUES ('FR', 1), ('GB', 1), ('CA', 2), ('FR', 2 );

SELECT *
FROM visited_countries_2
JOIN users
ON users.id = user_id;